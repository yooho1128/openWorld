    ...
    tasks: [
      {
        ...
        required: true,
        choices: [
          { label: '적극적으로 질문한다', message: '적극적으로 질문하며 수업에 참여했다.', delta: { intelligence: 4, happiness: -1 } },
          { label: '조용히 필기하며 듣는다', message: '조용히 필기하며 수업을 들었다.', delta: { intelligence: 2, happiness: 1 } },
        ],
    ...
    tasks: [
      {
        ...
        required: true,
        choices: [
          { label: '꼼꼼하게 검토하며 처리한다', message: '꼼꼼하게 검토하며 업무를 처리했다. 실수가 없었다.', delta: { intelligence: 3, happiness: -1 } },
          { label: '빠르게 끝내고 정시 퇴근한다', message: '빠르게 업무를 끝내고 정시에 퇴근했다.', delta: { happiness: 3, stamina: 1 } },
        ],
