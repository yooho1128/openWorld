...
export function rollHuntEncounter(region, character = null) {
  ...
  const titleBonus = character?.equippedTitle === 'lucky-lottery' ? 0.02 : 0;
  const bossChance = Math.min(0.95, 0.04 + region.danger * 0.005 + titleBonus);
